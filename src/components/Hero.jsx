    ...
    <section id="hero" className="relative overflow-hidden px-6 py-24 text-center transition-colors duration-300 md:py-28">
      ...
      <div className="mx-auto max-w-4xl">
        ...
        <div className="flex flex-wrap items-center justify-center gap-4">
          <a href="#booking" className="rounded-2xl bg-sky-600 px-8 py-4 text-center font-bold text-white shadow-lg shadow-sky-600/20 transition-all hover:-translate-y-0.5 hover:bg-sky-700 dark:shadow-none">
            {t('heroBtnBook')}
          </a>

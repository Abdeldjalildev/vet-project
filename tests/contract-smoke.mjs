...
assert.match(rules, /request\.resource\.data\.currency\.matches\('\^\[A-Z\]\{3\}\assert.match(rules, /resource\.data\.active == true && get\(\/databases\/\$\(database\)\/documents\/clinics\/\$\(clinicId\)\)/)

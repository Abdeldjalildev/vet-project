...
The public application already consumes clinic branding through CSS variables. This does not introduce arbitrary CSS, arbitrary page layouts, or a page-builder system.

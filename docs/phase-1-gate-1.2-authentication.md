...
**Status:** IMPLEMENTED — EXTERNAL FIREBASE AUTH CONFIGURATION VERIFICATION REQUIRED  
...
- Firebase Auth is initialized from the existing Firebase App.
...
- Auth state is observed centrally through `onAuthStateChanged`.
...
5. Local build/login verification succeeds.
